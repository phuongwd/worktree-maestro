...
import { listWorktrees, getChangedFilesCount, commitAll, push, hasRemote, getDefaultBranch, } from '../utils/git.js';
import { isGhInstalled, isGhAuthenticated, createPullRequest, getPrForBranch, generatePrTitle, generatePrBody, } from '../utils/github.js';
...
export async function createPrTool(input) {
    try {
        // Check gh CLI
        if (!isGhInstalled()) {
            return {
...
function generateCommitMessage(branch, ticket) {
