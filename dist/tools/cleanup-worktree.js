...
import { listWorktrees, removeWorktree as gitRemoveWorktree, deleteBranch, getChangedFilesCount, getRepoRoot, } from '../utils/git.js';
...
export async function cleanupWorktreeTool(input) {
    const warnings = [];
    const actions = [];
    try {
        // Find the worktree
...
//# sourceMappingURL=cleanup-worktree.js.map